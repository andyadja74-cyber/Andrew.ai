...
const https = require("https"); // Fix: https au lieu de http
const {
...
async function startBot() {
  ...
  const sock = makeWASocket({
    ...
    browser: ["Ubuntu", "Chrome", "20.0.04"], // Fix: Navigateur mis à jour pour Baileys
  ...
  if (!sock.authState.creds.registered && !pairingCodeDemande) {
    ...
    }, 6000); // Fix: 6 secondes pour stabiliser la connexion initiale
  }
